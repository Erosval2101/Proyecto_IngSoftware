...
namespace ProyectoIngSoftware
{
    ...
    {
        String id_vendedor;
        public ConsultarVenta(String id)
        {
            InitializeComponent();
            id_vendedor = id;
        }
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            buscar.CommandText = ("select * from venta where IDVenta = '" + txtIDVenta.Text + "' and ID_Empleado = '" + id_vendedor + "'");
            ...
            {
                MessageBox.Show("No se encontró la venta", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                dtgvVenta.Rows.Clear();
