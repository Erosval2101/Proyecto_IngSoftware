                                    ...
                                    if (txtCorreo.Text != "")
                                    {
                                        if (txtContrasena.Text != "")
                                        {
                                            if (txtSalario.Text != "")
                                            {
                                                ...
                                                String query = "insert into empleado(IDEmpleado, Nombre_Empleado, Ap_Paterno, Ap_Materno, Puesto, H_Entrada, H_Salida, Numero_Telefono, CorreoElectronico, Contrasena, Salario, ImagenEmpleado) values (@id, @nombre, @ap_pat, @ap_mat, @puesto, @h_ent, @h_sal, @num_tel, @correo, @contrasena, @salario, @img)";
