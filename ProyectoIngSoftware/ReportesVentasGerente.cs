...
{
    public partial class ReportesVentasGerente : Form
    {
        public ReportesVentasGerente()
        {
            InitializeComponent();
        }
        ...
        private void ReportesVentasGerente_Load(object sender, EventArgs e)
        {
            ...
            buscar.CommandText = ("select * from venta");
